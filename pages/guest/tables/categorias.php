...
<div class="container mt-5">
    ...
    <div class="row">
        <!-- Solo la lista de categorías, sin formulario para agregar/actualizar -->
        <div class="col-md-12">
...
<script src="/autoservicios/assets/js/view_categorias.js"></script>
